	...
	<body>
		...
		<div id="show-disease" class="content scaffold-show" role="main">
			...
			<ol class="property-list disease">
				...
				<g:if test="${diseaseInstance?.percentSurvival}">
				<li class="fieldcontain">
					<span id="percentSurvival-label" class="property-label"><g:message code="disease.percentSurvival.label" default="Percent Survival" /></span>
					
						<span class="property-value" aria-labelledby="percentSurvival-label"><g:fieldValue bean="${diseaseInstance}" field="percentSurvival"/></span>
					
				</li>
				</g:if>
			
			</ol>
			<g:form url="[resource:diseaseInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${diseaseInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
