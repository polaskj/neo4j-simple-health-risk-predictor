...
<html>
	...
	<body>
		<a href="#list-disease" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-disease" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${diseaseInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
