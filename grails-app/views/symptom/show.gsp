	...
	<body>
		...
		<div id="show-symptom" class="content scaffold-show" role="main">
			...
			<ol class="property-list symptom">
				...
				<g:if test="${symptomInstance?.suggestedTreatment}">
				<li class="fieldcontain">
					<span id="suggestedTreatment-label" class="property-label"><g:message code="symptom.suggestedTreatment.label" default="Suggested Treatment" /></span>
					
						<span class="property-value" aria-labelledby="suggestedTreatment-label"><g:fieldValue bean="${symptomInstance}" field="suggestedTreatment"/></span>
					
				</li>
				</g:if>
			
			</ol>
			<g:form url="[resource:symptomInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${symptomInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
